...
describe('Routing: test_odb', function () {
    ...
    describe('xAccount', function () {
        it('should return 10 accounts', function (done) {

            // We do this using the request object, requiring supertest!
            request(url).get('/xaccount')
        ...
        it('should correctly get an existing account by EOID', function (done) {
