...
<xsl:stylesheet 
	...
	xmlns:typ="http://services.tdeu.telekom.net/ServAndResMgmt/TechOrderMgmt/ProductionFulfillmentProvider_v01.00/types"
	xmlns:bom="http://system-services.t-home.telekom.de/ServiceManagement/TechnicalOrderManagement/ProductionFulfillment_v01.01/types"
	...
	<xsl:template match="/">
		<xsl:apply-templates select="/soapenv:Envelope/soapenv:Body//bom:serviceOrder"/>
	...
	<xsl:template match="bom:productionPlan|bom:abortProductionPlan|bom:abortProductionPlanCallback|bom:OISException">
		<html>
			<head>
